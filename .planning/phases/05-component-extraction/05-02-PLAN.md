...
<task type="auto">
  ...
  <action>
Create `components/ConfigDialog.jsx` by extracting lines 276-369 from egg-calculator.jsx (the config dialog modal).
...
Export as named export: `export const ConfigDialog = ...`
  ...
  <done>ConfigDialog.jsx created with exact JSX from lines 276-369, accepting all data as props, with proper imports for useTranslation.</done>
</task>
...
Extract lines 373-435 from egg-calculator.jsx (the timer overlay).
...
Extract lines 722-741 from egg-calculator.jsx (consistency selection).
